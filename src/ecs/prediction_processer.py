...
#################################################星期前同一天数据求平均##################################################
    ...
    #     # predict_func = predict_model.model23_used_func  # 78.712
    #     vmtype_avage_v = 1
    if end_time == pos_time2 and data_size == range_size2 and vm_type_size > preliminar2_1_size and vm_type_size<=preliminar2_2_size:  # 样例4  L2  2016-04-15 预测天数7  虚拟机类型5 (3,5]
