...
PM_TYPE = {
    'General': {'CPU': 56, 'MEM': 128, 'HDD': 1200},
    'Large-Memory': {'CPU': 84, 'MEM': 256, 'HDD': 2400},
    'High-Performance': {'CPU': 112, 'MEM': 192, 'HDD': 3600}
}
...
PREDICT_MODEL10_WEIGHTS = {
    'flavor1': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor2': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor3': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},

    'flavor4': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor5': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    ...
    'flavor11': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor12': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},

    'flavor13': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor14': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor15': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},

    'flavor16': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
    'flavor17': {'n': 6, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},
...
PREDICT_MODEL21_WEIGHTS = {  # 84.543 #有  ##无
    ...
    'flavor6': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##

    'flavor7': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},  # -
    'flavor8': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.80},  # +  1.8
    'flavor9': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},  # -

    'flavor10': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor11': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},  # -
    'flavor12': {'n': 10, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.45},  # -
...
PREDICT_MODEL29_WEIGHTS = {  # 84.543 #有  ##无
    'flavor1': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.54},  # +
    'flavor2': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.65},  # -
    'flavor3': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 2.0},  # +

    'flavor4': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor5': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor6': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##

    'flavor7': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.65},  # -
    'flavor8': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.185},  # +  1.8
    'flavor9': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.65},  # -

    'flavor10': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor11': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.65},  # -
    'flavor12': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.65},  # -

    'flavor13': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor14': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor15': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##

    'flavor16': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor17': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
    'flavor18': {'n': 14, 'back_week': 1, 'beta': 2.0, 'enlarge': 1.49},  ##
}
...
PREDICT_MODEL2_WEIGHTS = {
    'flavor1': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor2': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor3': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},

    'flavor4': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor5': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor6': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},

    'flavor7': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor8': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor9': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},

    'flavor10': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor11': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor12': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},

    'flavor13': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor14': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor15': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},

    'flavor16': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor17': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
    'flavor18': {'alpha': 0.22, 'beta': 0.0, 'gamma': 0.215, 's': 7, 'enlarge': 1.00},
}
